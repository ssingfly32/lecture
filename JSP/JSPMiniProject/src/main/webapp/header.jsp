...
<body>
	...
	<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="${contextPath }/index.jsp">ksh</a>
			...
			<div class="collapse navbar-collapse" id="mynavbar">
				<ul class="navbar-nav me-auto">
					...
					<c:choose>
						...
						<c:otherwise>
							<li class="nav-item"><a class="nav-link"
								href="${contextPath }/member/myPage.mem?userId=${sessionScope.loginUser.userId }"><img
									src="${contextPath }/${sessionScope.loginUser.memberImg}"
									class="userImg" />${sessionScope.loginUser.userId }</a></li>
