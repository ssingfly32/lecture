...
public class EmployeeCRUD {
	...
	public Employee getEmployeeByEmpNo(int empNo) throws NamingException, SQLException {
	...
	public int updateEmployee(Employee saveEmp) throws NamingException, SQLException {
		int result = -1;
		Connection con = DBConnection.getInstance().dbConnect();
		...
		PreparedStatement pstmt = con.prepareStatement(query);
		pstmt.setString(1, saveEmp.getFirst_name());
		pstmt.setString(2, saveEmp.getLast_name());
		pstmt.setString(3, saveEmp.getEmail());
		pstmt.setString(4, saveEmp.getPhone_number());
		pstmt.setDate(5, saveEmp.getHire_date());
		pstmt.setString(6, saveEmp.getJob_id());
		pstmt.setFloat(7, saveEmp.getSalary());
		pstmt.setFloat(8, saveEmp.getCommission_pct());
		pstmt.setInt(9, saveEmp.getManager_id());
		pstmt.setInt(10, saveEmp.getDepartment_id());
		pstmt.setInt(11, saveEmp.getEmployee_id());
